	 ...
	 <div class="header-breadcrumbs">
		...
		<div id="sidebar">
			...
			<table>
				...
				<tr>
					<td><a href="makebill.html">A0001</a></td>
					<td><a href="../servicecenter/customerinfor.html">A0001</a></td>
					<td>乔伟</td>
					<td>送货</td>
					<td>已完成</td>
					<td>2012/07/07</td>
					<td><a href="makebill.jsp">领票</a>&nbsp;<a href="rebill.jsp">作废</a></td>
				</tr>
				<tr>
					<td><a href="taskinfor.jsp">A0001</a></td>
					<td><a href="../servicecenter/customerinfor.jsp">A0001</a></td>
					<td>乔伟</td>
					<td>送货</td>
					<td>已完成</td>
					<td>2012/07/07</td>
					<td><a href="#">领票</a>&nbsp;<a href="rebill.jsp">作废</a></td>
				</tr>
				<tr>
					<td><a href="taskinfor.jsp">A0001</a></td>
					<td><a href="../servicecenter/customerinfor.jsp">A0001</a></td>
